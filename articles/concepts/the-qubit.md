...
Även om detta är ett enkelt exempel (eftersom <xref:microsoft.quantum.intrinsic.h> åtgärden är självständig) kan du se hur det blir värdefullt för mer komplicerade qubit-åtgärder.
...
Med andra ord är en uppsättning portar en universell grind uppsättning om en enhetlig omvandling kan vara ungefär skriven som en produkt av portar från den här uppsättningen. Vi kräver att för alla före skrivna fel, finns det portar $G _ {1} , G_ {2} , \ldots, G_N $ från den grind som
