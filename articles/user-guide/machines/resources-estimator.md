...
<span data-ttu-id="7bbc5-108">Du kan använda resurs uppskattningen för att köra alla Q# åtgärder.</span><span class="sxs-lookup"><span data-stu-id="7bbc5-108">You can use the resources estimator to run any Q# operation.</span></span> <span data-ttu-id="7bbc5-109">Mer information finns i [sätt att köra ett Q# program](xref:microsoft.quantum.guide.host-programs).</span><span class="sxs-lookup"><span data-stu-id="7bbc5-109">For additional details, see [Ways to run a Q# program](xref:microsoft.quantum.guide.host-programs).</span></span>
...
<span data-ttu-id="7bbc5-122">När du kör ett Q# program från kommando raden använder du parametern **--Simulator** (eller **-s** Shortcut) för att ange `ResourcesEstimator` mål datorn.</span><span class="sxs-lookup"><span data-stu-id="7bbc5-122">When running a Q# program from the command line, use the **--simulator** (or **-s** shortcut) parameter to specify the `ResourcesEstimator` target machine.</span></span> <span data-ttu-id="7bbc5-123">Följande kommando kör ett program med hjälp av resurs uppskattningen:</span><span class="sxs-lookup"><span data-stu-id="7bbc5-123">The following command runs a program using the resources estimator:</span></span> 
...
<span data-ttu-id="7bbc5-125">Använd Q# kommandot% unmagic kommandot [%](xref:microsoft.quantum.iqsharp.magic-ref.simulate) för att köra Q# åtgärden.</span><span class="sxs-lookup"><span data-stu-id="7bbc5-125">Use the IQ# magic command [%estimate](xref:microsoft.quantum.iqsharp.magic-ref.simulate) to run the Q# operation.</span></span>
...
|<span data-ttu-id="7bbc5-144">__Djuplodande__</span><span class="sxs-lookup"><span data-stu-id="7bbc5-144">__Depth__</span></span>|<span data-ttu-id="7bbc5-145">Djupet i Quantum-kretsen som körs av Q# åtgärden (se [nedan](#depth-width-and-qubitcount)).</span><span class="sxs-lookup"><span data-stu-id="7bbc5-145">Depth of the quantum circuit run by the Q# operation (see [below](#depth-width-and-qubitcount)).</span></span> <span data-ttu-id="7bbc5-146">Djup måttet räknar som standard bara `T` grindar.</span><span class="sxs-lookup"><span data-stu-id="7bbc5-146">By default, the depth metric only counts `T` gates.</span></span> <span data-ttu-id="7bbc5-147">Mer information finns i [djup räknare](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span><span class="sxs-lookup"><span data-stu-id="7bbc5-147">For more details, see [Depth Counter](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span></span>   |
|<span data-ttu-id="7bbc5-148">__LED__</span><span class="sxs-lookup"><span data-stu-id="7bbc5-148">__Width__</span></span>|<span data-ttu-id="7bbc5-149">Bredden på den Quantum-krets som körs av Q# åtgärden (se [nedan](#depth-width-and-qubitcount)).</span><span class="sxs-lookup"><span data-stu-id="7bbc5-149">Width of the quantum circuit run by the Q# operation (see [below](#depth-width-and-qubitcount)).</span></span> <span data-ttu-id="7bbc5-150">Djup måttet räknar som standard bara `T` grindar.</span><span class="sxs-lookup"><span data-stu-id="7bbc5-150">By default, the depth metric only counts `T` gates.</span></span> <span data-ttu-id="7bbc5-151">Mer information finns i [djup räknare](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span><span class="sxs-lookup"><span data-stu-id="7bbc5-151">For more details, see [Depth Counter](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span></span>   |
|<span data-ttu-id="7bbc5-152">__QubitCount__</span><span class="sxs-lookup"><span data-stu-id="7bbc5-152">__QubitCount__</span></span>    |<span data-ttu-id="7bbc5-153">Den nedre gränsen för maximalt antal allokerade qubits under körningen av Q# åtgärden.</span><span class="sxs-lookup"><span data-stu-id="7bbc5-153">The lower bound for the maximum number of qubits allocated during the run of the Q# operation.</span></span> <span data-ttu-id="7bbc5-154">Det här måttet kanske inte är kompatibelt med __djupet__ (se nedan).</span><span class="sxs-lookup"><span data-stu-id="7bbc5-154">This metric might not be compatible with __Depth__ (see below).</span></span>  |
|<span data-ttu-id="7bbc5-155">__BorrowedWidth__</span><span class="sxs-lookup"><span data-stu-id="7bbc5-155">__BorrowedWidth__</span></span>    |<span data-ttu-id="7bbc5-156">Det maximala antalet qubits som lånas i Q# åtgärden.</span><span class="sxs-lookup"><span data-stu-id="7bbc5-156">The maximum number of qubits borrowed inside the Q# operation.</span></span>  |
