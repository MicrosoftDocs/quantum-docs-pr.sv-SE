...
---
# <a name="_jordanwigneroptimizedblockencoding_-function"></a>Funktionen _JordanWignerOptimizedBlockEncoding_
...
## <a name="output--intintdoubleblockencodingreflection"></a>Utdata: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double),[BlockEncodingReflection](xref:Microsoft.Quantum.Simulation.BlockEncodingReflection)))
