...
---
# <a name="intasstring-function"></a>Funktionen IntAsString
...
Konverterar ett angivet heltals värde till en motsvarande sträng representation.
...
Mer information finns i [C# Convert. toString](https://docs.microsoft.com/dotnet/api/system.convert.tostring?view=netframework-4.7.1#System_Convert_ToString_System_Int64_) .