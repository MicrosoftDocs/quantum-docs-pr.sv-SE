...
---
# <a name="inplacexorbe-operation"></a>InPlaceXorBE-åtgärd
...
> [!WARNING]
> InPlaceXorBE är föråldrad. Använd <xref:ApplyReversedOpLECA(ApplyXorInPlace(value, _), target)> i stället.
>
> Den här åtgärden har tagits bort.
...
### <a name="target--bigendian"></a>mål: [BigEndian](xref:Microsoft.Quantum.Arithmetic.BigEndian)
