...
### <a name="onresultzeroop--t--unit--is-adj"></a>onResultZeroOp: t => [enhet](xref:microsoft.quantum.lang-ref.unit)  är just just
...
### <a name="onresultoneop--u--unit--is-adj"></a>onResultOneOp: ' U => [enhet](xref:microsoft.quantum.lang-ref.unit)  är just
