...
---
# <a name="ampampbyoracle-function"></a>Funktionen AmpAmpByOracle
...
> [!WARNING]
> AmpAmpByOracle är föråldrad. Använd <xref:Microsoft.Quantum.AmplitudeAmplification.StandardAmplitudeAmplification> i stället.
>
> Använd @"microsoft.quantum.amplitudeamplification.standardamplitudeamplification".
