...
---
# <a name="modularincrementle-operation"></a>ModularIncrementLE-åtgärd
...
> [!WARNING]
> ModularIncrementLE är föråldrad. Använd <xref:Microsoft.Quantum.Arithmetic.ModularIncrementByInteger> i stället.
>
> Använd @"Microsoft.Quantum.Arithmetic.ModularIncrementByInteger".
