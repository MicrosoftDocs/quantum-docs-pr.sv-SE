...
---
# <a name="integerincrementle-operation"></a>IntegerIncrementLE-åtgärd
...
> [!WARNING]
> IntegerIncrementLE är föråldrad. Använd <xref:Microsoft.Quantum.Arithmetic.IncrementByInteger> i stället.
>
> Använd @"Microsoft.Quantum.Arithmetic.IncrementByInteger".
