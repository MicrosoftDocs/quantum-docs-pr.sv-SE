...
---
# <a name="inplacexorle-operation"></a>InPlaceXorLE-åtgärd
...
> [!WARNING]
> InPlaceXorLE är föråldrad. Använd <xref:Microsoft.Quantum.Measurement.ApplyXorInPlace> i stället.
>
> Använd @"Microsoft.Quantum.Measurement.ApplyXorInPlace".
