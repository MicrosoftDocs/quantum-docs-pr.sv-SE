...
---
# <a name="modularaddproductle-operation"></a>ModularAddProductLE-åtgärd
...
> [!WARNING]
> ModularAddProductLE är föråldrad. Använd <xref:Microsoft.Quantum.Arithmetic.MultiplyAndAddByModularInteger> i stället.
>
> Använd @"Microsoft.Quantum.Arithmetic.MultiplyAndAddByModularInteger".
